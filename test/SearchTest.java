...
public class SearchTest 
{
    ...
    public static void main(final String[] args) throws Exception 
	{
		...
		while(w <= loop)
		{
			...
			//int declarations - arguments into command line
    	...
    	System.out.println("Total Probes: " + total);
	    System.out.println("Probes set " + args[3] + " Searches: " + set);
    	System.out.println("Average Probes per Search: " + search);
